...
# process -------------------------------------------------------------
exp_idx_df <- exp_process_df[, c("PG.Gene", "PG.ProteinName", "PG.ProteinDescriptions", "PG.ProteinAccession", "PTM_Name")]
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "Phosphorylation_zscore.", run_id, ".tsv")
