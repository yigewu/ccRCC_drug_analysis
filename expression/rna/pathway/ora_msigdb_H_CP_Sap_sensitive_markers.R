...
#                                 mart = ensembl)
genesymbol2entrezid_df <- fread(data.table = F, input = "./Resources/Analysis_Results/expression/rna/pathway/ora_msigdb_H_CP_Sap_sensitive_markers/20211117.v1/genesymbol2entrezid.tsv")
...
genes_process_df <- markers_df %>%
  filter(gene_category == "Sap sensitive") %>%
