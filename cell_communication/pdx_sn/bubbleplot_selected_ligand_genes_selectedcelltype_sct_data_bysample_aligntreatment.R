...
gene2cellgroup_plot_df <- data.frame(gene_symbol = c("VEGFA", "EFNA5", "EFNB2", "TGFA", "NCAM1", "NCAM1", "IL34", "HGF"),
                                     cell_group = c("Tumor.cells", "Tumor.cells", "Endothelial.cells", "Tumor.cells", "Tumor.cells", "Fibroblasts",  "Myofibroblasts", "Tumor.cells"))
