...
# input dependencies ------------------------------------------------------
gi_group_sup_df <- fread(data.table = F, input = "./Resources/Analysis_Results/treatment_data/extract_cellline_growth_inhibtion_bydrugs_091121/20210911.v1/RCC_Cellline.Growth_Inhibition.20210911.v1.tsv")
