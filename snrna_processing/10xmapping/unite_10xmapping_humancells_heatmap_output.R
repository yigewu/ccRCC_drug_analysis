...
dir_10xmapping <- paste0("./Resources/snRNA_Processed_Data/10XMapping/outputs/run_samples.PDX_snRNA.humancells.katmai/")
...
# write table -------------------------------------------------------------
write.table(x = mutation_map_sup_tab, file = paste0(dir_out, "10XMapping.HumanCells.mapping_heatmap.", run_id, ".tsv"), quote = F, sep = "\t", row.names = F)
