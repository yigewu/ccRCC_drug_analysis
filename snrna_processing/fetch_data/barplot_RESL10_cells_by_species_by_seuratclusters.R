...
## input fetched data
fetcheddata_df <- fread(input = "./Resources/Analysis_Results/snrna_processing/fetch_data/fetch_data_RESL10_4sample_integration_withanchor_on_katmai/20200423.v1/RESL10_4sample_integration.withanchor.20200417.v1.fetched_data.20200423.v1.tsv", data.table = F)
