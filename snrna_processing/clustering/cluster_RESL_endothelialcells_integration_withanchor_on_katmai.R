...
path_rds <- "./Resources/Analysis_Results/snrna_processing/integration/run_RESL_8sample_endothelialcells_integration_withanchor_on_katmai/20200508.v1/RESL.Endothelial_cells.integration.withanchor.20200508.v1.RDS"
## set integration id
id_integration <- "RESL.Endothelial_cells.integration.withanchor.20200507.v1"
## input RDS file
