...
for (id_sample in ids_sample) {
  ...
  ## make seurat object
  srat <- Seurat::CreateSeuratObject(counts = input, project = id_sample)
  print("Finished creatting the seurat object!")
  rm(input)
  ...
  ## save outputs
  file2write <- paste0(dir_out, id_sample, ".mouse", ".seruat_filtered.", run_id, ".RDS")
...
file2write <- paste0(dir_out, "Path_to_Seurat_Objects.MouseCells.Filtered.", run_id, ".tsv")
