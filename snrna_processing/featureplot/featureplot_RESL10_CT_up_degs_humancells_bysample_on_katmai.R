...
## input DEGs
deg_df <- fread(data.table = F, input = "./Resources/Analysis_Results/snrna_processing/findmarkers/clusterprofiler/run_clusterprofiler_on_degs_humancells_RESL10_CT_up/20210217.v1/ORA.Result.20210217.v1.tsv")
## input RDS file
srat <- readRDS(file = path_rds)
DefaultAssay(srat) <- "RNA"

## input marker gene table
genes_plot <- sapply(deg_df$geneID, function(x) {
