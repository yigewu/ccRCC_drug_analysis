...
## input DEGs
deg_df <- fread(data.table = F, input = "./Resources/Analysis_Results/snrna_processing/findmarkers/clusterprofiler/run_clusterprofiler_on_degs_humancells_RESL5_CT_up/20210217.v1/ORA.Result.20210217.v1.tsv")
## input RDS file
